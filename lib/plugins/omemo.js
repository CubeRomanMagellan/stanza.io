...
module.exports.OmemoStorage = class OmemoStorage {
  constructor() {
    this.store = new OmemoLocalStorageStore('omemo/');
  }
...
module.exports.OmemoAddress = class OmemoAddress extends SignalProtocolAddress {
  constructor(name, deviceId) {
    super(typeof(name) === 'string' ? name : name.bare, deviceId);
  }
}

module.exports.OmemoUtils = class OmemoUtils {
...
module.exports.OmemoClient = class OmemoClient {
